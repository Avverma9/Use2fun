...
const Setupsallery = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`https://use2fun.onrender.com/admin/salarySetup/get`);
      if (!response.ok) {
  ...
  const fetchSalaryData = async () => {
    try {
      const response = await fetch(`https://use2fun.onrender.com/admin/diamoindValue/get`);
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
      const responseData = await response.json();
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch('https://use2fun.onrender.com/admin/salarySetup/update', {
        method: 'PUT',
        headers: {
  ...
  const handleSalarySubmit = async () => {
    try {
      const response = await fetch('https://use2fun.onrender.com/admin/diamoindValue/update', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
